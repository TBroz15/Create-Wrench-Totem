...
import dev.tuxebro.create_wrench_totem.networking.CustomTotemAniamtionPayload;import net.createmod.catnip.lang.FontHelper;
...
public class CreateWrenchTotem {
    ...
    public CreateWrenchTotem(IEventBus modEventBus, ModContainer modContainer) {
        ...
        modEventBus.addListener(CustomTotemAniamtionPayload::register);
    }
}
